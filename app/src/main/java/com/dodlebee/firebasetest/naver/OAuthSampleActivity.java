...
public class OAuthSampleActivity extends Activity {
	 ...
	 * client 정보를 넣어준다.
	 */
	private static String OAUTH_CLIENT_ID = "TEXlZhV0XDBKk6ObS4to";
	private static String OAUTH_CLIENT_SECRET = "x7OVLnWyU6";
	private static String OAUTH_CLIENT_NAME = "API테스트";
